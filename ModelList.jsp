...
<table width="75%" border="1">
 ...
 <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model:</strong>
        Double Mass Gainer</font><input type="hidden" name="modelNo" value="Double Mass Gainer">
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Description:</strong>
        Processor:lolipop,Ram:3GB,primary camera:8mp. </font><input type="hidden" name="description" value="Processor:lolipop,Ram:3GB,Primary Camera:8MP."></p>
      ...
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Image:</strong><input type="hidden" name="img" ><img src="images/imageedit.png"  alt="image"  width="150"height="150"/>
      ...
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Price:</strong>
        1500.00Rs </font><input type="hidden" name="price" value="1500"></p><input type="hidden" name="action" value="add"><input type="submit" name="addToCart" value="Add To Cart">
      </form></td>
