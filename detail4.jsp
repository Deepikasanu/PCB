...
<br><br>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
             ...
             <header>
    <hgroup>
      <h1>L'Oreal Paris Total</h1>
      <h4>Keep your body healthy.</h4>
  ...
  <figure>
   ...
   <span class='zoom' id='ex1'>
		<img src='images/TR5-Masque-Vmag.jpg' width='555' height='320' alt='Daisy on the Ohoopee'/>
		<p></p>
	</span>
	...
	<!-- <span class='zoom' id='ex3'>
		<img src='one.png' width='555' height='320' alt='Daisy on the Ohoopee'/>
  ...
  <details>
   ...
   <!-- 
      <ul>
        ...
        <li>3GB RAM and 32GB ROM</li>
        <li>Air Print and finger print</li>
        <li> Android Lolipop5</li>
        <li>Photo and video geotagging</li>
      <li><b>Availability:</b>Yes</li>
      <li><b>Price:</b>8500.00 Rs</li>
      </ul>
       -->
		Fights the 5 signs of hair damage.
   ...
   <div class="shopping_cart">
					<div class="cart">
						<a href="ModelList3.jsp" title="View my shopping cart" rel="nofollow">
